...
\begin{document}
	...
	\frame {
		...
		The total energy of the system is the sum of energies from Equations (1-3) and a load on the top substrate,		
	...
	\frame {
		\frametitle{Second experiment with ten fibers}
		\includegraphics[scale=.5]{./fig/ch4/grid.eps}	
	}
